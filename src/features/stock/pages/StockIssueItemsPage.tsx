  ...
  return (
    ...
    >
      ...
      <DataTable<StockIssueItem>
        columns={[
          { key: "transactionDate", header: "Date", cellClassName: "text-[10px] text-slate-500 font-mono whitespace-nowrap", render: (item) => item.transactionDate ? new Date(item.transactionDate).toLocaleDateString("en-US", { month: "short", day: "2-digit", year: "numeric" }) : "" },
          ...
          { key: "quantity", header: "Qty", align: "right", cellClassName: "font-mono text-slate-700 dark:text-gray-300 whitespace-nowrap" },
          { key: "uom", header: "UoM", cellClassName: "text-slate-500" },
          { key: "unitPrice", header: "Unit Price", align: "right", cellClassName: "font-mono text-slate-700 dark:text-gray-300 whitespace-nowrap", render: (item) => `$${Number(item.unitPrice).toFixed(2)}` },
          { key: "totalPrice", header: "Total Amount", align: "right", cellClassName: "font-mono text-slate-700 dark:text-gray-300 whitespace-nowrap", render: (item) => `$${Number(item.totalPrice).toFixed(2)}` },
          ...
          { key: "actions", header: "Actions", align: "center", cellClassName: "text-center", render: (item) => (
