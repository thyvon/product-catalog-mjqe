...
export default function ExcelImportModal({
  ...
  return (
    ...
    >
      {/* Header Panel */}
      <div className="p-5 border-b border-slate-100 dark:border-gray-800 flex justify-between items-center bg-slate-50/50 dark:bg-gray-800/50 shrink-0">
        <div>
      ...
      <div className="p-4 border-t border-slate-100 dark:border-gray-800 flex justify-end gap-3 bg-slate-50/30 dark:bg-gray-800/30 shrink-0">
        <button
